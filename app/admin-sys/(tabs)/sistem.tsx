...
const SISTEM_ITEMS: AdminModuleItem[] = [
  { title: "Master Wilayah", description: "Kelola master data wilayah administratif (Provinsi, Kabupaten/Kota, Kecamatan, Desa/Kelurahan)", icon: "map", route: "/admin-sys/geography" },
  { title: "Pengaturan Sistem", description: "Konfigurasi parameter dan pengaturan global platform", icon: "gear" },
  { title: "Audit Log", description: "Lacak aktivitas dan perubahan di seluruh platform", icon: "verified" },
  { title: "Keamanan & Sesi", description: "Kelola kebijakan keamanan, sesi pengguna, dan akses", icon: "lock" },
  { title: "Backup & Export", description: "Kelola backup data dan ekspor laporan sistem", icon: "upload" },
];

export default function AdminSysSistemScreen() {
    ...
    <SysAdminRouteGuard>
      <ScreenContainer className="px-6">
        <View style={styles.content}>
          ...
          <Text style={[styles.title, { color: colors.foreground }]}>Sistem</Text>
          <Text style={[styles.description, { color: colors.muted }]}>Konfigurasi infrastruktur, keamanan, dan data master platform.</Text>
