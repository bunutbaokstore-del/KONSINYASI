...
export default function DistributorFinanceScreen() {
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.headerRow}>
          <View style={styles.headerCopy}>
            ...
            <Text style={[styles.subtitle, { color: colors.muted }]}>Ringkasan keuangan draft dari HPP, Budget, Produksi, Stok, dan Pengiriman ruang kerja.</Text>
          </View>
