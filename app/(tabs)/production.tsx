        ...
        ListHeaderComponent={
          <View>
            ...
            <View style={[styles.segment, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              ...
              <Pressable accessibilityRole="button" onPress={() => switchView("stock")} style={[styles.segmentButton, view === "stock" && { backgroundColor: colors.primary }]}><Text style={[styles.segmentText, { color: view === "stock" ? colors.background : colors.muted }]}>Stok Hasil Produksi</Text></Pressable>
